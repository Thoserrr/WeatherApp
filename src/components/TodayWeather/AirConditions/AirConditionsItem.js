  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* เปลี่ยนข้อความ title เป็นภาษาไทย */}
          {props.title === 'Real Feel' ? 'ความรู้สึกจริง' : 
           props.title === 'Wind' ? 'ลม' :
           props.title === 'Clouds' ? 'เมฆ' :
           props.title === 'Humidity' ? 'ความชื้น' : props.title}
        </Box>
      </Grid>
      <Grid
        item
      ...
      >
        ...
        >
          {/* เปลี่ยนข้อความ value เป็นภาษาไทย */}
          {props.value}
        </Box>
      </Grid>
    </Grid>
